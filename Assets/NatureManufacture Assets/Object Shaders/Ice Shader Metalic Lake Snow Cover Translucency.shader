Shader "NatureManufacture Shaders/Ice Lake/Ice Shader Metalic Lake  Snow Cover Translucency"
{
	Properties
	{
		[Header(Translucency)]
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float4 lerpResult314 = lerp( lerpResult286 , float4( 0,0,0,0 ) , temp_output_285_0);
			o.Translucency = lerpResult314.xyz;
			o.Alpha = 1;
		}
